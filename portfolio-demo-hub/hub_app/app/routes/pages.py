...
SOLUTION_PAGES = {
    "ai-chatbot-for-website": {
        ...
        "title": "AI-консультант для сайтов клиентов — AI Automation",
    ...
    "smart-lead-form": {
        "url": "/smart-lead-form",
        "title": "Умная форма заявки для сайтов клиентов — AI Automation",
    ...
    "wordpress-ai-integration": {
        ...
        "title": "AI-консультант и умные формы для WordPress-сайтов — AI Automation",
    ...
    "automation-for-agencies": {
        ...
        "title": "Автоматизация заявок для агентств и специалистов по сайтам — AI Automation",
    ...
    "website-development-for-partners": {
        ...
        "title": "Разработка сайтов для дизайнеров, маркетологов и SEO — AI Automation",
    ...
    return templates.TemplateResponse(
        ...
        public_context(
            ...
            schema_data=webpage_schema(
                ...
                "Контактная страница AI Automation для обсуждения сайта, AI-консультанта, умной формы или партнёрства.",
                "/contact",
            ),
        ),
    )
